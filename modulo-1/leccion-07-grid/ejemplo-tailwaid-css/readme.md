Tailwind es un framework de CSS basado en clases utilitarias: en lugar de usar componentes predefinidos, aplicas estilos directamente con clases pequeñas y reutilizables.
